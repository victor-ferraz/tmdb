//==================================================================================================
//  Filename      : packet_control_adc.v
//  Created On    : 2015-03-16 21:35:58
//  Last Modified : 2015-03-28 09:28:56
//  Revision      : 
...
localparam HALF_SAMPLES = (NUM_SAMPLES-1)/2;
localparam INIT_OFFSET = L1_FIFO_DEPTH - HALF_SAMPLES;
...
//Registers
reg [L1_ADDRESS_WIDTH-1:0] offset;
reg write_enable_l2;
...
assign read_address_l1 = l1_reference_addr_in - (delay_in + offset);
